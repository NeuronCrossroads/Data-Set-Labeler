...
var image;
var curImgURL = "";
var imageURLFile = "https://raw.githubusercontent.com/NeuronCrossroads/Auralux-THREE/master/url.txt";
...
$("#GnBtn").click(function(){curColor = gunRed});
...
$("#emailButton").click(function(){
    ...
    if (name == "")
        name = "AnonymousUser";
    document.location = "ary.dhatt@gmail.com"+"?subject="+"DATA"+"&body="+"Hello shadySourceBot,\n\nI have a contribution to make!!\n\nSincerely,\n"+name;
